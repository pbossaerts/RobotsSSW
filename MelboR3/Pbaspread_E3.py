...
mark = 173 #  market
begin_session = 1673  # Round 1 (PB changed first session id to 1673 to have continguous sessions IDs)
# (From marketplaceSSWalt.csv)
...
plt.title("B/A Spread [Experiment 3]")
plt.ylabel("Spread (Cents)")
plt.xlabel("Time (Seconds)")
plt.show()
