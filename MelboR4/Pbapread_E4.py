# -*- coding: utf-8 -*-
"""
Created on Wed 17/3/2021, changed on Wed 3/5/2023 (this version deletes computes of (e) below,
since it takes too much time.
Important note: reads "output15ADD.xls," where columns "owner" and "target" had to be deleted!
Otherwise identification of columns by number does not match column content as in experiment 1
...
name = 'output15ADD.xls' # FM csv file converted to xls (from marketplaceSSWmonash.csv)
mark = 191 #  market
...
plt.title("B/A Spread [Experiment 4]")
